...
| 当前状态 | 已恢复到 `start_epoch=1, global_step=34318`，进入 `Epoch 2/4`，最新人工检查到 step 38017；已保存到 `compressor_e2_s38000.pt`；日志未见 OOM/Traceback |
...
| 数据量 | `TeacherCacheDataset: 102952` |
| 当前状态 | 已进入 epoch1，最新人工检查到 step 21426；已保存 `compressor_e1_s1000.pt` 到 `compressor_e1_s21000.pt`；日志未见 OOM/Traceback |
